...
List<ProdukListWrapper> produkListWrapperFromJson(String str) => List<ProdukListWrapper>.from(json.decode(str).map((x) => ProdukListWrapper.fromJson(x)));

String produkListWrapperToJson(List<ProdukListWrapper> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProdukListWrapper {
  ProdukListWrapper({
    this.prdId,
    this.katId,
    this.prdName,
  ...
  factory ProdukListWrapper.fromJson(Map<String, dynamic> json) => ProdukListWrapper(
    prdId: json["prd_id"],
    katId: json["kat_id"],
